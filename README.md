...
```bash
dotnet run -- \
  --input pennette-con-cavolfiore-pomodori-secchi-e-bufala.svg \
  --output1 logo_512.webp \
  --output2 logo_1024.webp \
  --width1 512 --height1 512 \
  --width2 1024 --height2 1024 \
...
> Nota: se il browser e il convertitore restano diversi, la causa può essere il motore di rendering SVG (Chrome vs Svg.Skia), non solo la compressione WebP.
